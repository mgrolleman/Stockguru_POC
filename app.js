(function(){
  ...
  var STRINGS = {
    en: {
      ...
      'welcome.tagline': "A quiz that <span style=\"color:var(--gold);\">teaches</span>. Real data to play.",
    ...
    nl: {
      ...
      'welcome.tagline': 'Een quiz die <span style="color:var(--gold);">leert</span>. Echte data om mee te spelen.',
  ...
  function typewriterReveal(el, html, speed){
    ...
    function step(){
      ...
      if(html.charAt(i) === '<'){
        ...
        if(end === -1){ el.innerHTML += html.slice(i); i = len; return; }
  ...
  function renderWelcomeScreen(){
    ...
    var taglineEl = document.getElementById('welcome-tagline-el');
    if(taglineEl) typewriterReveal(taglineEl, t('welcome.tagline'), 28);
  }
