(function(){
  ...
  var CHART_COLORS = {
    ...
    dark: {
      allworld: { color:'#5B8DEF', fill:'#1C2A45' },
      spx:      { color:'#7B74E8', fill:'#22213F' },
      gold:     { color:'#9B5DE0', fill:'#2A1F3D' },
      nflx:     { color:'#B14AD6', fill:'#321F3A' },
      btc:      { color:'#C93BC0', fill:'#351F35' }
    }
  };
  ...
  function updateWhatIf(){
    ...
    chartEl.innerHTML = buildChartSVG(slice, assetC.color, assetC.fill);
