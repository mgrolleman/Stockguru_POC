(function(){
  ...
  // ---------- i18n ----------
  // Note: quiz question/answer content and the per-section "learn more" narratives
  // stay English-only for now (see quiz.englishOnlyNote). Everything else below is
  ...
  var STRINGS = {
    en: {
      ...
      'welcome.tagline': "The best app that combines a learning quiz and playing with real data!",
      ...
      'home.playdataNote': 'Want to see how that plays out? Check the Play with data tab for real examples and a what-if calculator.',
      ...
      'quiz.englishOnlyNote': 'Quiz questions are available in English only for now.',
      ...
      'playdata.allworldExplainer': "A global stock ETF like this spreads your money across thousands of companies in dozens of countries, so it rides broad global growth rather than any single market's swings.",
      ...
      'playdata.spxExplainer': 'The S&P 500 tracks 500 of the largest U.S. companies, and ETFs that follow it are often seen as lower-risk than picking individual stocks since your money is spread across all 500 at once.',
      'playdata.spxCaption': 'Illustrative monthly averages, not real-time data. Source: S&P Dow Jones Indices, via Yahoo Finance.',
      'playdata.goldTitle': 'Gold — last 5 years, monthly (USD/oz)',
      'playdata.goldExplainer': "Gold doesn't pay dividends or interest, but it has held or grown its value through the same stretch — which is why many investors use it as a hedge rather than a growth engine.",
      'playdata.goldCaption': 'Illustrative monthly figures, not real-time data. Source: Macrotrends, JM Bullion.',
      'playdata.btcTitle': 'Bitcoin — last 5 years, monthly (USD)',
      'playdata.btcExplainer': 'Bitcoin swings far more sharply than the other three in this list — big rallies, deep drops — which is exactly the trade-off between higher potential return and higher risk.',
      'playdata.btcCaption': 'Illustrative monthly figures, not real-time data. Source: CoinGecko, SoFi, Official Data.',
      ...
      'playdata.assetGold': 'Gold',
      'playdata.assetCrypto': 'Crypto (Bitcoin)',
      'playdata.horizonLabel': 'Time horizon',
      'playdata.horizon1': '1 year ago',
      'playdata.horizon2': '2 years ago',
      'playdata.horizon3': '3 years ago',
      'playdata.horizon4': '4 years ago',
      'playdata.horizon5': '5 years ago',
      'playdata.strategyLabel': 'Strategy',
      'playdata.strategyLump': 'Buy once',
      'playdata.strategyDca': 'Buy monthly (DCA)',
      'playdata.assumptions': '"Buy once" assumes a single lump-sum purchase made at the very start of your selected time horizon, held until today. "Buy monthly (DCA)" means dollar-cost averaging — investing a fixed amount every month instead of all at once, something many beginner investors do (as covered in the quiz), since it smooths out the effect of timing. The examples above use \u20AC1,000 as a placeholder — since we\'re looking at percentage return, the actual amount you\'d invest doesn\'t change the result.',
      'playdata.caption': 'Based on the same illustrative monthly figures shown above. Not financial advice.',
      'playdata.tradeLogTitle': 'Track a real trade',
      'playdata.tradeLogIntro': 'Log a buy or sell for a month, and check back later to see what return it would have earned.',
      'playdata.buy': 'Buy',
      'playdata.sell': 'Sell',
      'playdata.tradeLogged': 'Logged: {action} {asset} for {month}. Return tracking is coming in a future update.',
      'playdata.tradeNoMonth': 'Pick a month first.',
      'playdata.resultLump': 'A single amount invested in {asset} {n} {yearWord} ago would be {dir} {pct}% today.',
      'playdata.resultDca': '\u20AC1,000 per month into {asset} over the last {n} {yearWord} would be {dir} {pct}% today.',
      'playdata.up': 'up',
      'playdata.down': 'down',
      'playdata.year': 'year',
      'playdata.years': 'years',
      ...
      'feedback.topicsTitle': 'Which main topics would you like to learn more about?',
    ...
    nl: {
      ...
      'welcome.tagline': 'De beste app die een leerzame quiz combineert met spelen met echte data!',
      ...
      'home.playdataNote': 'Benieuwd hoe dat uitpakt? Bekijk het tabblad Play with data voor echte voorbeelden en een what-if-calculator.',
      ...
      'quiz.englishOnlyNote': 'Quizvragen zijn voorlopig alleen in het Engels beschikbaar.',
      ...
      'summary.backToPath': 'Terug naar het pad',
      ...
      'playdata.allworldExplainer': "Een wereldwijde aandelen-ETF zoals deze spreidt je geld over duizenden bedrijven in tientallen landen, waardoor je meelift op brede wereldwijde groei in plaats van de bewegingen van één markt.",
      ...
      'playdata.spxExplainer': "De S&P 500 volgt 500 van de grootste Amerikaanse bedrijven, en ETF's die deze index volgen worden vaak gezien als minder risicovol dan het kiezen van individuele aandelen, omdat je geld over alle 500 tegelijk wordt gespreid.",
      'playdata.spxCaption': 'Illustratieve maandgemiddelden, geen realtime data. Bron: S&P Dow Jones Indices, via Yahoo Finance.',
      'playdata.goldTitle': 'Goud — afgelopen 5 jaar, maandelijks (USD/oz)',
      'playdata.goldExplainer': 'Goud keert geen dividend of rente uit, maar heeft zijn waarde over dezelfde periode behouden of laten groeien — daarom gebruiken veel beleggers het als afdekking in plaats van als groeimotor.',
      'playdata.goldCaption': 'Illustratieve maandcijfers, geen realtime data. Bron: Macrotrends, JM Bullion.',
      'playdata.btcTitle': 'Bitcoin — afgelopen 5 jaar, maandelijks (USD)',
      'playdata.btcExplainer': 'Bitcoin schommelt veel sterker dan de andere drie in dit lijstje — grote pieken, diepe dalen — precies de afweging tussen hoger potentieel rendement en hoger risico.',
      'playdata.btcCaption': 'Illustratieve maandcijfers, geen realtime data. Bron: CoinGecko, SoFi, Official Data.',
      ...
      'playdata.assetGold': 'Goud',
      'playdata.assetCrypto': 'Crypto (Bitcoin)',
      'playdata.horizonLabel': 'Tijdshorizon',
      'playdata.horizon1': '1 jaar geleden',
      'playdata.horizon2': '2 jaar geleden',
      'playdata.horizon3': '3 jaar geleden',
      'playdata.horizon4': '4 jaar geleden',
      'playdata.horizon5': '5 jaar geleden',
      'playdata.strategyLabel': 'Strategie',
      'playdata.strategyLump': 'Eenmalig kopen',
      'playdata.strategyDca': 'Maandelijks kopen (DCA)',
      'playdata.assumptions': '"Eenmalig kopen" gaat uit van een eenmalige investering aan het allereerste begin van je gekozen tijdshorizon, aangehouden tot vandaag. "Maandelijks kopen (DCA)" betekent dollar-cost averaging — elke maand een vast bedrag beleggen in plaats van alles ineens, iets wat veel beginnende beleggers doen (zoals behandeld in de quiz), omdat het het effect van timing uitvlakt. De voorbeelden hierboven gebruiken \u20AC1.000 als plaatshouder — omdat we naar het percentage rendement kijken, verandert het daadwerkelijke bedrag niets aan het resultaat.',
      'playdata.caption': 'Gebaseerd op dezelfde illustratieve maandcijfers als hierboven. Geen financieel advies.',
      'playdata.tradeLogTitle': 'Volg een echte transactie',
      'playdata.tradeLogIntro': 'Leg een aankoop of verkoop vast voor een maand, en kijk later terug om te zien wat het rendement zou zijn geweest.',
      'playdata.buy': 'Kopen',
      'playdata.sell': 'Verkopen',
      'playdata.tradeLogged': 'Vastgelegd: {action} {asset} voor {month}. Rendementstracking volgt in een toekomstige update.',
      'playdata.tradeNoMonth': 'Kies eerst een maand.',
      'playdata.resultLump': 'Een eenmalig bedrag belegd in {asset}, {n} {yearWord} geleden, zou vandaag {pct}% {dir} staan.',
      'playdata.resultDca': '\u20AC1.000 per maand beleggen in {asset} over de afgelopen {n} {yearWord} zou vandaag {pct}% {dir} staan.',
      'playdata.up': 'hoger',
      'playdata.down': 'lager',
      'playdata.year': 'jaar',
      'playdata.years': 'jaar',
      ...
      'feedback.title': 'Feedback',
      'feedback.subtitle': 'Vertel ons wat we moeten toevoegen, verbeteren of beter uitleggen — elke opmerking helpt de volgende sectie vorm te geven.',
      ...
      'feedback.topicsTitle': 'Over welke hoofdonderwerpen zou je meer willen leren?',
  ...
  function buildChartSVG(data, lineColor, fillColor){
  ...
  function renderSPXChart(){
    renderChartInto('spx-chart', SPX_DATA, '#1F7A5C', '#DCEBE3');
    renderChartInto('allworld-chart', ALLWORLD_DATA, '#3A6EA5', '#DCE7F2');
    renderChartInto('gold-chart', GOLD_DATA, '#B8862F', '#F2E6CC');
    renderChartInto('btc-chart', BITCOIN_DATA, '#B5473B', '#F5DEDA');
    updateWhatIf();
  }

  var WHATIF_ASSETS = {
    allworld: { key:'allworld', data: ALLWORLD_DATA, label:'the All World ETF', color:'#3A6EA5', fill:'#DCE7F2' },
    spx: { key:'spx', data: SPX_DATA, label:'the S&P 500', color:'#1F7A5C', fill:'#DCEBE3' },
    gold: { key:'gold', data: GOLD_DATA, label:'gold', color:'#B8862F', fill:'#F2E6CC' },
    btc: { key:'btc', data: BITCOIN_DATA, label:'Bitcoin', color:'#B5473B', fill:'#F5DEDA' }
  };
  ...
  function updateWhatIf(){
    ...
    var horizonEl = document.getElementById('whatif-horizon');
    ...
    if(!assetEl || !horizonEl || !strategyEl || !chartEl || !resultEl) return;

    var asset = WHATIF_ASSETS[assetEl.value];
    var horizonYears = parseInt(horizonEl.value, 10);
    var strategy = strategyEl.value;
    var months = horizonYears * 12;
    var slice = asset.data.slice(asset.data.length - months);

    chartEl.innerHTML = buildChartSVG(slice, asset.color, asset.fill);

    var returnPct, resultText;
    var yearWord = horizonYears === 1 ? t('playdata.year') : t('playdata.years');
    var assetLabel = whatifAssetLabel(asset);

    if(strategy === 'lump'){
      var startVal = slice[0].value;
      var endVal = slice[slice.length-1].value;
      returnPct = ((endVal/startVal) - 1) * 100;
      resultText = t('playdata.resultLump', {
        asset: assetLabel, n: horizonYears, yearWord: yearWord,
        dir: returnPct >= 0 ? t('playdata.up') : t('playdata.down'),
        pct: Math.abs(returnPct).toFixed(1)
      });
    } else {
      var monthlyAmount = 1000;
      var totalShares = 0;
      slice.forEach(function(d){ totalShares += monthlyAmount / d.value; });
      var totalInvested = monthlyAmount * slice.length;
      var finalValue = totalShares * slice[slice.length-1].value;
      returnPct = ((finalValue/totalInvested) - 1) * 100;
      resultText = t('playdata.resultDca', {
        asset: assetLabel, n: horizonYears, yearWord: yearWord,
        dir: returnPct >= 0 ? t('playdata.up') : t('playdata.down'),
        pct: Math.abs(returnPct).toFixed(1)
      });
    ...
    var pctClass = returnPct >= 0 ? 'pos' : 'neg';
    var pctSign = returnPct >= 0 ? '+' : '';
    resultEl.innerHTML =
      '<div class="whatif-pct ' + pctClass + '">' + pctSign + returnPct.toFixed(1) + '%</div>' +
      '<div class="whatif-desc">' + resultText + '</div>';
  }

  ['whatif-asset','whatif-horizon','whatif-strategy'].forEach(function(id){
  ...
  function renderFeedbackSummary(data){
    ...
    els.feedbackSummaryBars.innerHTML = orderedTopics.map(function(t){
      ...
      var countLabel = isDummy ? (t.value + '%') : t.value;
  ...
  function startLesson(unitIndex, level){
    ...
    var questionSet = level === 'intermediate' ? section.intermediate : (level === 'advanced' ? section.advanced : section.questions);
    session = {
      unitIndex: unitIndex,
      level: level,
      qIndex: 0,
  ...
  function renderQuestion(){
    ...
    var langNote = document.getElementById('quiz-lang-note');
    if(langNote){
      langNote.classList.toggle('hidden', state.lang !== 'nl');
      if(state.lang === 'nl') langNote.textContent = t('quiz.englishOnlyNote');
    }
  ...
  function pickFriendlyVoice(){
    ...
    var friendly = voices.find(function(v){
      return /en/i.test(v.lang) && /samantha|victoria|female|aria|zira|jenny/i.test(v.name);
    });
    return friendly || voices.find(function(v){ return /en/i.test(v.lang); }) || voices[0];
  }
  ...
  els.speakBtn.addEventListener('click', function(){
    ...
    utterance.onend = function(){ els.speakBtn.textContent = t('summary.listenBtn'); };
    utterance.onerror = function(){ els.speakBtn.textContent = t('summary.listenBtn'); };
    window.speechSynthesis.speak(utterance);
    els.speakBtn.textContent = t('summary.stopBtn');
  });
  ...
  function logFakeTrade(action){
    var noteEl = document.getElementById('trade-log-note');
    var monthInput = document.getElementById('trade-month');
    if(!noteEl || !monthInput) return;
    if(!monthInput.value){
      noteEl.textContent = t('playdata.tradeNoMonth');
      noteEl.classList.remove('hidden');
      return;
    }
    var assetSelect = document.getElementById('whatif-asset');
    var asset = WHATIF_ASSETS[assetSelect ? assetSelect.value : 'allworld'];
    noteEl.textContent = t('playdata.tradeLogged', {
      action: t('playdata.' + action),
      asset: whatifAssetLabel(asset),
      month: formatMonthInput(monthInput.value)
    });
    noteEl.classList.remove('hidden');
  }

  var tradeBuyBtn = document.getElementById('trade-buy-btn');
  var tradeSellBtn = document.getElementById('trade-sell-btn');
  if(tradeBuyBtn) tradeBuyBtn.addEventListener('click', function(){ logFakeTrade('buy'); });
  if(tradeSellBtn) tradeSellBtn.addEventListener('click', function(){ logFakeTrade('sell'); });
  ...
  if(initialLangBtn){
    [document.getElementById('lang-en'), document.getElementById('lang-nl')].forEach(function(btn){
      btn.classList.toggle('active', btn === initialLangBtn);
    });
  }
  updateTopbar();
