(function(){
  ...
  var STRINGS = {
    en: {
      ...
      'playdata.assumptions': '"Buy once" assumes a single lump-sum purchase made on your chosen buy date, held until your chosen sell date. "Buy monthly (DCA)" means dollar-cost averaging — investing a fixed amount every month across that same period instead of all at once, something many beginner investors do (as covered in the quiz), since it smooths out the effect of timing. Since we\'re looking at percentage return, the actual amount you\'d invest doesn\'t change the result.',
