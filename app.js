(function(){
  ...
  var STRINGS = {
    en: {
      ...
      'welcome.tagline': "The best app that combines inspiring quizzes with slowly increasing complexity, and hands-on play with actual financial data.",
    ...
    nl: {
      ...
      'welcome.tagline': 'De beste app die inspirerende quizzen met langzaam toenemende complexiteit combineert met praktisch spelen met echte financiële data.',
