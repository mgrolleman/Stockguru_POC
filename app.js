(function(){
  ...
  var STRINGS = {
    en: {
      ...
      'welcome.mission': "<span style=\"color:var(--gold);\">Learn to invest</span>, from your first step to your next level.",
      'welcome.taglineLine1': "A quiz that <span style=\"color:var(--gold);\">teaches</span>.",
      'welcome.taglineLine2': "Real data to <span style=\"color:var(--gold);\">play</span>.",
      'welcome.taglineSub': "Across stocks, funds and crypto.",
      'welcome.getStarted': 'Get started',
      'welcome.introduction': 'Introduction',
      'welcome.proceed': 'Proceed',
      'welcome.disclaimer': "AppName does not provide financial advice. It's built for education only.",
      ...
      'experience.howTitle': 'How AppName works',
      ...
      'summary.backToPath': 'Back to quiz',
      ...
      'playdata.allworldTitle': 'All World ETF',
      ...
      'playdata.allworldInsight': 'Steady growth over the last 5 years, with a clear dip in 2022 as interest rates rose and inflation fears spread.',
      'playdata.allworldCaption': 'Illustrative monthly figures, indexed to 100 at the start. Not real-time data.',
      'playdata.spxTitle': 'S&P 500',
      ...
      'playdata.spxInsight': 'Strong growth, largely driven by tech stocks, with a clear dip in 2022 when interest rates rose sharply.',
      'playdata.spxCaption': 'Illustrative monthly averages, not real-time data.',
      'playdata.goldTitle': 'Gold',
      ...
      'playdata.goldInsight': 'A strong rise, especially from 2024 onward, as uncertainty and high inflation pushed investors toward safe havens.',
      'playdata.goldCaption': 'Illustrative monthly figures, not real-time data.',
      'playdata.btcTitle': 'Bitcoin',
      ...
      'playdata.btcInsight': 'Huge swings — sharp peaks like late 2024, but also steep drops, like the 2022 "crypto winter".',
      'playdata.btcCaption': 'Illustrative monthly figures, not real-time data.',
      'playdata.nflxTitle': 'Netflix',
      ...
      'playdata.nflxInsight': 'A hard climb, but also a crash of over 70% in 2022 after a shock subscriber loss, before rallying over 600% to a new high, then dropping again. A single well-known stock can swing far harder than a diversified fund.',
      ...
      'playdata.assetAllworld': 'All World',
      'playdata.assetStock': 'S&P 500',
      'playdata.assetGold': 'Gold (metals)',
      'playdata.assetCrypto': 'Crypto (Bitcoin)',
      'playdata.assetNflx': 'Netflix',
      'playdata.assetAapl': 'Apple',
      'playdata.assetMsft': 'Microsoft',
      'playdata.assetNvda': 'Nvidia',
      'playdata.assetTsla': 'Tesla',
      'playdata.assetAsml': 'ASML',
      'playdata.assetGoogl': 'Alphabet (Google)',
      'playdata.assetAmzn': 'Amazon',
      'playdata.assetMeta': 'Meta',
      'playdata.assetNke': 'Nike',
      'playdata.assetNasdaq100': 'Nasdaq-100',
      ...
      'playdata.dataSourceNoteExamples': 'Charts show illustrative monthly figures over the last 5 years, not real-time data (the All World ETF is indexed to 100 at the start; Netflix is adjusted for its November 2025 stock split). Figures are refreshed daily and sourced from reputable open sources such as Yahoo Finance.',
      ...
      'playdata.showIntroduction': 'Show introduction',
      'playdata.hideIntroduction': 'Hide introduction',
      ...
      'feedback.showResults': 'Show what others are saying',
      'feedback.hideResults': 'Hide what others are saying',
      ...
      'feedback.nameVoteTitle': 'What is a good app name?',
      'feedback.nameVoteSubtitle': 'Pick as many as you like — or suggest your own below.',
      'feedback.nameVoteCustomPlaceholder': 'Your own suggestion (optional)',
      'feedback.anythingElse': 'Anything else?',
      'feedback.placeholder': "What should AppName cover next, or what's not working?",
      'feedback.send': 'Send feedback',
      'feedback.thanks': 'Thanks — your feedback is saved.',
      'feedback.disclaimerConfigured': 'Your feedback is saved on this device, and shared with the AppName team so we can improve the app.',
    ...
    nl: {
      ...
      'welcome.mission': '<span style="color:var(--gold);">Leer beleggen</span>, van je eerste stap tot je volgende niveau.',
      'welcome.taglineLine1': 'Een quiz die <span style="color:var(--gold);">leert</span>.',
      'welcome.taglineLine2': 'Echte data om mee te <span style="color:var(--gold);">spelen</span>.',
      'welcome.taglineSub': 'Met aandelen, fondsen en crypto.',
      'welcome.getStarted': 'Aan de slag',
      'welcome.introduction': 'Introductie',
      'welcome.proceed': 'Doorgaan',
      'welcome.disclaimer': 'AppName geeft geen financieel advies. De app is uitsluitend bedoeld voor educatie.',
      ...
      'experience.howTitle': 'Hoe AppName werkt',
      ...
      'playdata.allworldInsight': 'Een gestage groei over de afgelopen 5 jaar, met een duidelijke dip in 2022 door stijgende rente en zorgen over inflatie.',
      ...
      'playdata.spxInsight': 'Sterke groei, grotendeels gedreven door technologiebedrijven, met een duidelijke dip in 2022 toen de rente snel omhoogging.',
      'playdata.spxCaption': 'Illustratieve maandgemiddelden, geen realtime data.',
      'playdata.goldTitle': 'Goud',
      ...
      'playdata.goldInsight': 'Een sterke stijging, vooral vanaf 2024, toen onzekerheid en hoge inflatie beleggers naar veilige havens dreven.',
      ...
      'playdata.btcInsight': "Enorme schommelingen — scherpe pieken zoals eind 2024, maar ook stevige dalingen, zoals de 'cryptowinter' van 2022.",
      ...
      'playdata.nflxInsight': 'Een harde stijging, maar in 2022 ook een instorting van meer dan 70% na een schokkend verlies van abonnees, om vervolgens meer dan 600% te herstellen naar een nieuwe piek, en daarna weer te dalen. Eén bekend aandeel kan veel harder schommelen dan een gespreid fonds.',
      ...
      'playdata.dataSourceNoteExamples': "Grafieken tonen illustratieve maandcijfers over de afgelopen 5 jaar, geen realtime data (de All World ETF is geïndexeerd op 100 aan het begin; Netflix is gecorrigeerd voor de aandelensplitsing van november 2025). Cijfers worden dagelijks ververst en komen van betrouwbare open bronnen zoals Yahoo Finance.",
      ...
      'playdata.sellLabel': 'Verkocht in',
      ...
      'playdata.showIntroduction': 'Toon introductie',
      'playdata.hideIntroduction': 'Verberg introductie',
      ...
      'feedback.showResults': 'Toon wat anderen zeggen',
      'feedback.hideResults': 'Verberg wat anderen zeggen',
      ...
      'feedback.nameVoteTitle': 'Wat is een goede app-naam?',
      'feedback.nameVoteSubtitle': 'Kies er zoveel als je wilt — of stel hieronder je eigen naam voor.',
      'feedback.nameVoteCustomPlaceholder': 'Jouw eigen suggestie (optioneel)',
      'feedback.anythingElse': 'Nog iets anders?',
      'feedback.placeholder': 'Wat moet AppName hierna behandelen, of wat werkt niet goed?',
      'feedback.send': 'Feedback versturen',
      'feedback.thanks': 'Bedankt — je feedback is opgeslagen.',
      'feedback.disclaimerConfigured': 'Je feedback wordt op dit apparaat opgeslagen, en gedeeld met het AppName-team zodat we de app kunnen verbeteren.',
  ...
  function switchPlaydataSubtab(subtab){
    ...
    ['subtab-examples','subtab-examples-bottom','subtab-examples-bottom2'].forEach(function(id){
      var btn = document.getElementById(id);
      if(btn) btn.classList.toggle('active', subtab === 'examples');
    });
    ['subtab-scenario','subtab-scenario-bottom','subtab-scenario-bottom2'].forEach(function(id){
      var btn = document.getElementById(id);
      if(btn) btn.classList.toggle('active', subtab === 'scenario');
    });
    window.scrollTo(0, 0);
  }
  ...
  ['subtab-examples','subtab-examples-bottom','subtab-examples-bottom2'].forEach(function(id){
    var btn = document.getElementById(id);
    if(btn) btn.addEventListener('click', function(){ switchPlaydataSubtab('examples'); });
  });
  ['subtab-scenario','subtab-scenario-bottom','subtab-scenario-bottom2'].forEach(function(id){
    var btn = document.getElementById(id);
    if(btn) btn.addEventListener('click', function(){ switchPlaydataSubtab('scenario'); });
  });
  ...
  function updateWhatIf(){
    ...
    var legendEl = document.getElementById('whatif-chart-legend');
    if(compareAsset && compareResult){
      ...
      chartEl.innerHTML = buildComparisonChartSVG(indexedA, assetC.color, indexedB, compareC.color, 250);
      ...
      if(legendEl){
        legendEl.innerHTML =
          '<div class="whatif-legend-item"><span class="whatif-legend-dot" style="background:' + assetC.color + '"></span>' + assetLabel + '</div>' +
          '<div class="whatif-legend-item"><span class="whatif-legend-dot" style="background:' + compareC.color + '"></span>' + whatifAssetLabel(compareAsset) + '</div>';
        legendEl.classList.remove('hidden');
      }
    } else {
      chartEl.innerHTML = buildChartSVG(primary.slice, assetC.color, assetC.fill, 250);
  ...
  var NAME_VOTE_OPTIONS = ['FinBattle','FinRival','FinDuel','FinChallenge','FinRace','InvestBattle','StockRace','MoneyChamp','AlphaPlay'];
  var nameVoteSelected = {};

  function renderNameVoteOptions(){
    nameVoteSelected = {};
    var list = document.getElementById('name-vote-list');
    if(!list) return;
    list.innerHTML = '';
    NAME_VOTE_OPTIONS.forEach(function(name){
      var card = document.createElement('div');
      ...
      card.innerHTML =
        ...
        '<span>'+name+'</span>';
      card.addEventListener('click', function(){
        nameVoteSelected[name] = !nameVoteSelected[name];
        card.classList.toggle('selected', nameVoteSelected[name]);
        card.querySelector('.topic-tick').innerHTML = nameVoteSelected[name] ? checkSVG() : '';
      });
  ...
  function resetGeneralFeedbackForm(){
    ...
    renderNameVoteOptions();
    var customNameEl = document.getElementById('name-vote-custom');
    ...
    els.feedbackSummaryCard.classList.add('hidden');
    var summaryToggleBtn = document.getElementById('feedback-summary-toggle');
    if(summaryToggleBtn) summaryToggleBtn.textContent = t('feedback.showResults');
    loadFeedbackSummary();
  }
  ...
  function typewriterReveal(el, html, speed, onComplete){
    if(!el) return;
    var myRun = (el._twRun || 0) + 1;
    el._twRun = myRun;
    var built = '';
    el.innerHTML = '';
    var i = 0;
    var len = html.length;
    function step(){
      if(el._twRun !== myRun) return;
      if(i >= len){ if(onComplete) onComplete(); return; }
      if(html.charAt(i) === '<'){
        var end = html.indexOf('>', i);
        if(end === -1){ built += html.slice(i); el.innerHTML = built; i = len; if(onComplete) onComplete(); return; }
        built += html.slice(i, end + 1);
        i = end + 1;
        step();
        return;
      }
  ...
  function renderWelcomeScreen(){
    ...
    var taglineEl1 = document.getElementById('welcome-tagline-el1');
    var taglineEl2 = document.getElementById('welcome-tagline-el2');
    if(taglineEl2) taglineEl2.innerHTML = '';
    if(taglineEl1){
      typewriterReveal(taglineEl1, t('welcome.taglineLine1'), 28, function(){
        if(taglineEl2) typewriterReveal(taglineEl2, t('welcome.taglineLine2'), 28);
      });
    }
  }
  ...
  function navigateTo(target){
    ...
    if(statsEl) statsEl.classList.toggle('hidden', target === 'welcome' || target === 'experience');

    var brandNameEl = document.querySelector('.brand-name');
    if(brandNameEl) brandNameEl.classList.toggle('hidden', target === 'welcome');

    var brandMarkEl = document.querySelector('.brand-mark');
    if(brandMarkEl) brandMarkEl.classList.toggle('hidden', target === 'welcome');

    var topbarEl = document.querySelector('.topbar');
    if(topbarEl) topbarEl.classList.toggle('no-border', target === 'welcome');
  ...
  els.generalFeedbackSubmit.addEventListener('click', function(){
    ...
    var nameVotes = Object.keys(nameVoteSelected).filter(function(k){ return nameVoteSelected[k]; });
    var customNameEl = document.getElementById('name-vote-custom');
    var customName = customNameEl ? customNameEl.value.trim() : '';
    if(!text && topics.length === 0 && selectedStars === 0 && nameVotes.length === 0 && !customName) return;
    saveFeedback({ type:'general', topics:topics, text:text, stars: selectedStars || null, nameVotes:nameVotes, customName:customName, date:todayStr() });
  ...
  var examplesInfoToggle = document.getElementById('examples-info-toggle');
  if(examplesInfoToggle){
    examplesInfoToggle.addEventListener('click', function(){
      var block = document.getElementById('examples-info-block');
      if(!block) return;
      var isHidden = block.classList.contains('hidden');
      block.classList.toggle('hidden', !isHidden);
      examplesInfoToggle.textContent = isHidden ? t('playdata.hideIntroduction') : t('playdata.showIntroduction');
    });
  }

  var feedbackSummaryToggle = document.getElementById('feedback-summary-toggle');
  if(feedbackSummaryToggle){
    feedbackSummaryToggle.addEventListener('click', function(){
      var card = document.getElementById('feedback-summary-card');
      if(!card) return;
      var isHidden = card.classList.contains('hidden');
      card.classList.toggle('hidden', !isHidden);
      feedbackSummaryToggle.textContent = isHidden ? t('feedback.hideResults') : t('feedback.showResults');
    });
  }
