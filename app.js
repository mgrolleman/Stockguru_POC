  ...
  var SECTIONS_NL = [
    {
      questions:[
        ...
        { q:"Wat is het belangrijkste verschil tussen een aandeel en een obligatie?", options:["Aandelen zijn eigendom, obligaties zijn schuld","Aandelen zijn schuld, obligaties zijn eigendom","Het is precies hetzelfde","Obligaties kunnen alleen door banken worden gekocht"], correct:0, explain:"Een aandeel kopen maakt je mede-eigenaar. Een obligatie kopen maakt je een geldschieter — de lener is je geld terug verschuldigd, plus rente." },
