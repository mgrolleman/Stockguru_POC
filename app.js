(function(){
  ...
  var STRINGS = {
    en: {
      ...
      'welcome.tagline': "The best app that combines an educational <span style=\"color:var(--gold);\">quiz</span> and <span style=\"color:var(--gold);\">playing</span> with real data — covering stocks, index funds, and crypto!",
    ...
    nl: {
      ...
      'welcome.tagline': 'De beste app die een educatieve <span style="color:var(--gold);">quiz</span> en <span style="color:var(--gold);">spelen</span> met echte data combineert — met aandelen, indexfondsen en crypto!',
